whittle_uce_probes <- function(uce_list_file,probe_fasta_file,basename,file_type) {
  ...
  print("e.g.")
  cat('whittle_uce_probes("C:\\Users\\Alana\\Dropbox\\beetles\\grey_whittled_probes\\uce_loci_from_baca_2017.txt","C:\\Users\\Alana\\Dropbox\\beetles\\grey_whittled_probes\\Coleoptera-UCE-1.1K-v1","whatever","uce_list")\n')
