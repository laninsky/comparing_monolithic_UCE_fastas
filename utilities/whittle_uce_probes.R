...
whittle_uce_probes <- function(uce_list_file,probe_fasta_file,file_type,taxa_filter,basename) {
  ...
  print("whittle_uce_probes(uce_list_file,probe_fasta_file,file_type,taxa_filter,basename)")
  ...
  print('taxa_filter is an option that allows you to filter just to the UCE loci recovered across all taxa if using the "monolithic" option = "Y" (filter based on this) or "N" (do not filter)')
